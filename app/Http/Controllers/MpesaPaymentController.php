...
//function to register the confirmation and validation urls
    ...
    function registerURLS()
    {
        ...
        $shortCode = env('SHORTCODE'); // provide the short code obtained from your test credentials

        /* This two files are provided in the project. */
        $confirmationUrl = env('CONFIRMATION_URL'); // path to your confirmation url. can be IP address that is publicly accessible or a url
        $validationUrl = env('VALIDATION_URL'); // path to your validation url. can be IP address that is publicly accessible or a url
...
//Simulate Transaction
    function simulateC2B($phone, $amount)
    {
        $url = 'https://sandbox.safaricom.co.ke/mpesa/c2b/v1/simulate';

        // $access_token = $access_token; // check file mpesa_accesstoken.php.
        $ShortCode = env('SHORTCODE'); // Shortcode. Same as the one on register_url.php
