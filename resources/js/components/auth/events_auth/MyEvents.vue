                            ...
                            <form class="w-full max-w-lg" enctype="multipart/form-data">
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full md:w-2/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input
                                            ...
                                            id="grid-event-name" type="text" placeholder="" v-model="modalEvent[0].name">
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    ...
                                    <div class="w-full md:w-2/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input
                                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                            id="grid-location-name" type="text" placeholder="" v-model="modalEvent[0].location">
                                        <!--                    <p class="text-red-500 text-xs italic">Please fill out this field.</p>-->
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-wrap -mx-3 mb-2">
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input
                                            ...
                                            id="start-date" type="date" placeholder="Albuquerque" v-model="modalEvent[0].start_date">
                                    </div>
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input
                                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            id="end-date" type="date" placeholder="Albuquerque" v-model="modalEvent[0].end_date">
                                    </div>
                                ...
                                <div class="flex flex-wrap -mx-3 mb-2">
                                    ...
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                        ...
                                        <input
                                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            id="grid-regular" type="number" placeholder="Ksh" v-model="modalEvent[0].regular">
                                    </div>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            showEditModal(id) {
                console.log(this.$store.getters.getUserEvents.filter(event => event.id === id))
