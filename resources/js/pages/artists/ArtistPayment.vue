        ...
        <div>
            <div v-if="booking"
                ...
                <div class="md:w-2/5 px-2">
                    ...
                    <img class="max-w-full max-h-full m-auto" :src="'/images/artistImages/' +booking.artist.image " alt="">
                </div>
                <div
...
<script>
    ...
    export default {
        ...
        methods: {
            fetchBookingDetails() {
                axios.get('/api/artists/booking-information/' + this.bookingCode+'/'+this.bookingId)
                    .then(response => {
