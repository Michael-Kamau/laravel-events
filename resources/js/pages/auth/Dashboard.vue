    ...
    <div class="flex w-screen max-h-screen">
        ...
        <div class="  w-3/6 md:w-1/6 bg-gray-400 p-2 side-menu fixed md:static h-screen">
            ...
            <div v-if="roleExists('admin')">
                <div class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-md font-semibold text-gray-700 mt-2">
                    <div @click="toggleExpand('adminArtistOpen')" class="flex justify-between">
                        <h1>Artists Menu </h1>
                        <svg viewBox="0 0 20 20" fill="currentColor" class="menu w-3 h-3">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                ...
                <div class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-md font-semibold text-gray-700 mt-2">
                    <div @click="toggleExpand('adminEventsOpen')" class="flex justify-between">
                        <h1>Events Menu</h1>
                        <svg viewBox="0 0 20 20" fill="currentColor" class="menu w-3 h-3">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                    ...
                    <div :class="itemFocus.adminEventsOpen ? 'block' : 'hidden'" class="px-2">
                        <router-link :to="{name:'eventManagers'}">
                    <span
                        class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-sm font-semibold text-gray-700 mt-2">Event Managers</span>
                        </router-link>
                        <br>
                    </div>
                ...
                <div class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-md font-semibold text-gray-700 mt-2">
                    <div @click="toggleExpand('adminVenuesOpen')" class="flex justify-between">
                        <h1>Venues Menu</h1>
                        <svg viewBox="0 0 20 20" fill="currentColor" class="menu w-3 h-3">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                    ...
                    <div :class="itemFocus.adminVenuesOpen ? 'block' : 'hidden'" class="px-2">
                        <router-link :to="{name:'venueManagers'}">
                    <span
                        class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-sm font-semibold text-gray-700 mt-2"> Venue Managers</span>
                        </router-link>
                        <br>
                    </div>
                </div>
            ...
            <div v-if="roleExists('artist')" class=" pl-1">
                <div class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-md font-semibold text-gray-700 mt-2">
                    <div @click="toggleExpand('artistsOpen')" class="flex justify-between">
                        <h1>Artist</h1>
                        <svg viewBox="0 0 20 20" fill="currentColor" class="menu w-3 h-3">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                    ...
                    <div :class="itemFocus.artistsOpen ? 'block' : 'hidden'" class="px-2">
                        <router-link :to="{name:'viewArtist'}">
                    <span
                        class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-sm font-semibold text-gray-700 mt-2">Artist Profile</span>
                        </router-link>
                        <br>
                        <router-link :to="{name:'artistBookings'}">
                    <span
                        class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-sm font-semibold text-gray-700 mt-2">Artist Bookings</span>
                        </router-link>
                        <br>
                    </div>
                </div>
            ...
            <div v-if="roleExists('event-manager')" class=" pl-1">
                <div class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-md font-semibold text-gray-700 mt-2">
                    <div @click="toggleExpand('eventsOpen')" class="flex justify-between">
                        <h1>Event</h1>
                        <svg viewBox="0 0 20 20" fill="currentColor" class="menu w-3 h-3">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                    ...
                    <div :class="itemFocus.eventsOpen ? 'block' : 'hidden'" class="px-2">
                        <router-link :to="{name:'myEvents'}">
                    <span
                        class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-sm font-semibold text-gray-700 mt-2">My Events</span>
                        </router-link>
                        <br>
                        <router-link :to="{ name: 'addEvent'}">
                    <span
                        class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-sm font-semibold text-gray-700 mt-2">Add Event</span>
                        </router-link>
                    </div>
                </div>
            ...
            <div v-if="roleExists('venue-manager')" class=" pl-1">
                <div class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-md font-semibold text-gray-700 mt-2">
                    <div @click="toggleExpand('venuesOpen')" class="flex justify-between">
                        <h1>Venue</h1>
                        <svg viewBox="0 0 20 20" fill="currentColor" class="menu w-3 h-3">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                    ...
                    <div :class="itemFocus.venuesOpen ? 'block' : 'hidden'" class="px-2">
                        <router-link :to="{name:'myVenues'}">
                    <span
                        class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-sm font-semibold text-gray-700 mt-2">My Venues</span>
                        </router-link>
                        <br>
                        <router-link :to="{ name: 'addVenue'}">
                    <span
                        class="inline-block w-full bg-gray-200 rounded px-3 py-2 text-sm font-semibold text-gray-700 mt-2">Add Venue</span>
                        </router-link>
                    </div>
                </div>
...
<script>
    export default {
        ...
        data() {
            return {
                adminArtistOpen: false,
                itemFocus: {
                    adminArtistOpen: false,
                    adminEventsOpen: false,
                    adminVenuesOpen: false,
                    artistsOpen: false,
                    eventsOpen: false,
                    venuesOpen: false
                }
        ...
        methods: {
            toggleExpand(itemKey) {
                Object.keys(this.itemFocus).forEach((key, index) => {
                    if (key !== itemKey) {
                        this.itemFocus[key] = false
                        console.log(this.itemFocus[key])
                    }
                });
                this.itemFocus[itemKey] = !this.itemFocus[itemKey]
            },
