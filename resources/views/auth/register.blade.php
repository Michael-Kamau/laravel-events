                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="'col-md-6">
                                    <select class="custom-select @error('account-type') is-invalid @enderror"
                            ...
                            <div class="form-group row">
                                ...
                                <p>By applying, you agree to our <a href="/terms" class="text-blue-600">Terms and conditions</a> </p>
